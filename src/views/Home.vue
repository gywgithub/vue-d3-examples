<template>
  <div class="main justify-center">
    <a class="github-corner" target="_blank" href="https://github.com/gywgithub/vue-d3-examples">
      <svg width="100" height="100" viewBox="0 0 250 250" style="fill: #409eff; color: #fff; position: absolute; top: 0; border: 0; right: 0">
